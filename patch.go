...
func Patch(url, postdata string, headers map[string]string, followlocation bool) (*Response, error) {

	req, err := http.NewRequest("PATCH", url, strings.NewReader(postdata))
